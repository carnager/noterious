...
describe("markdown helpers", function () {
  ...
  it("renders bare URLs as anchors", function () {
    expect(renderInline("Visit https://example.com/docs for details.")).toBe(
      'Visit <a class="markdown-external-link" href="https://example.com/docs" target="_blank" rel="noopener">https://example.com/docs</a> for details.'
    );
  });
  ...
  it("renders nested markdown inside standard link labels", function () {
    expect(renderInline("[**Bold** and _italic_](https://example.com)")).toBe(
      '<a class="markdown-external-link" href="https://example.com" target="_blank" rel="noopener"><strong>Bold</strong> and <em>italic</em></a>'
    );
  });
  ...
  it("renders autolinks and escaped markdown markers", function () {
    expect(renderInline("<https://example.com> and escaped \\*stars\\*")).toBe(
      '<a class="markdown-external-link" href="https://example.com" target="_blank" rel="noopener">https://example.com</a> and escaped *stars*'
    );
  });
  ...
  it("renders reference-style links when definitions are provided", function () {
    ...
    expect(renderInline("Use [this one][ref-link] or [this][1].", {referenceDefinitions})).toBe(
      'Use <a class="markdown-external-link" href="https://example.com/reference" target="_blank" rel="noopener">this one</a> or <a class="markdown-external-link" href="https://example.com/numbered" target="_blank" rel="noopener">this</a>.'
    );
  });
